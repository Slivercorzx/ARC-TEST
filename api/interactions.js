// Verify + defer + forward to GAS (handles Google 30x redirect)
...
async function postToGAS(url, payload) {
  // 1st shot: manual redirect to keep POST
  let r = await fetch(url, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', 'User-Agent': 'arc-vercel-bridge/1.2' },
